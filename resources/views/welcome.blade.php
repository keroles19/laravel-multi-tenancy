...
@section('content')
    ...
    sm:items-center bg-dots white:bg-gray-900 selection:bg-indigo-500 selection:text-white">
                            ...
                            @auth
                                ...
                                <a href="{{ route('home') }}"
                                   ...
                                   dark:text-gray-400 dark:hover:text-white focus:outline
                                    focus:outline-2 focus:rounded-sm focus:outline-indigo-500 mr-3"
                                > Home </a>
                                <button form="logout"
                                   class="font-semibold text-gray-600 hover:text-gray-900
                                   dark:text-gray-400 dark:hover:text-white focus:outline
                                    focus:outline-2 focus:rounded-sm focus:outline-indigo-500">Logout</button>
